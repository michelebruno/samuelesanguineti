...
export default function Home() {
  ...
  return <Layout>
    ...
    <div className="row">
      <div className="col-12 col-md-7 border border-dark border-left-0
        border-bottom-0 d-flex flex-column justify-content-between"
           style={{minHeight: '75vh'}}>
        <p className={' py-5'}>I was born and raised in a town called
          ...
          where I got my first <b>degree in Graphic Design and Art Direction</b>. I was
          ...
          Master’s in <b>Design for the Fashion System at Politecnico di Milano</b>,
        ...
        <ul className="list-unstyled">
          <li><b>Master Degree</b>, Design for the Fashion System, Politecnico di
            Milano, 2019
          </li>
          <li><b>Bachelor Degree</b>, Graphic desing e art direction, NABA, 2018</li>
      ...
      <div className="col-12 col-md-4">
        <p>Milano / Italia <br/>
          for information and collaboration</p>
        <p>
          <a href="">@samusang</a><br/>
          <a href="">Linkedin</a>
        </p>
      </div>
    </div>
